...
class _IncomeScreenState extends ConsumerState<IncomeScreen>
  ...
  Future<void> _saveTransaction() async {
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Pemasukan tersimpan! 💰', style: GoogleFonts.nunito()),
          backgroundColor: const Color(0xFF4CAF50),
          behavior: SnackBarBehavior.floating,
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
        ),
  ...
  Widget _buildIncomePage() {
    final walletsAsync = ref.watch(incomeWalletProvider);

    return GestureDetector(
      onTap: () => FocusScope.of(context).unfocus(),
      child: Scaffold(
        backgroundColor: const Color(0xFFB8F0C8),
                  ...
                  Center(
                    child: AnimatedBuilder(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          '👆  swipe atas untuk riwayat pemasukan',
                          style: GoogleFonts.nunito(
                            fontSize: 12,
  ...
  Widget _buildCategoryPicker() {
    final categoriesAsync = ref.watch(categoryProvider('income'));
                  ...
                  children: [
                    ...
                    Text(cat.name,
                        style: GoogleFonts.nunito(
                          fontSize: 12,
                          fontWeight: FontWeight.w700,
                          color: isSelected ? Colors.white : const Color(0xFF5C4A6E),
                        )),
                  ],
                ),
              ),
